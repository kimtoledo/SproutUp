...
- **2026-08-30 — Admin actor isolation:** Approval maker, checker, and action actor foreign keys now
  target `admin_accounts`; staff grants execute only against `admin_role_grants`. Customer account
  classes and compatibility roles cannot be proposed through this workflow.
