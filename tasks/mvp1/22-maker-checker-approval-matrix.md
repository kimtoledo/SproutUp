...
- The cross-domain command/threshold matrix, amendment/supersession, alerting, emergency override, operator history APIs, and financial command integrations remain; this task stays **WIP**.
