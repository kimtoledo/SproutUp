...
- [ ] [02 — Authentication, RBAC & Audit](./02-auth-rbac-audit.md) — separate account relations, global email ownership, exact backfill, isolated admin runtime/cookie/context, staff RBAC/approval/reviewer and registry-backed domain ownership foreign keys, legacy admin auth cleanup, controlled initial provisioning, immutable audit, and dual-controlled staff role changes are implemented; borrower/investor runtime, recovery/MFA, and remaining controls remain
