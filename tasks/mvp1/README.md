...
- [ ] [21 — Borrower & Investor Portal Journeys](./21-borrower-investor-portal-journeys.md) — SproutUp Tailwind design system + accessible component kit + installable PWA shell established; independent admin/borrower/investor marketing and auth layouts plus permission-driven onboarding actions and immutable case timeline UI implemented; profile/evidence screens, portal/admin kit migration, and complete end-to-end journeys remain
