...
- [ ] [02 — Authentication, RBAC & Audit](./02-auth-rbac-audit.md) — password/session boundary, registration/login UI, audited customer-intent bootstrap, access catalogue, own-session revocation, canonical RBAC, immutable audit, dual-controlled role changes, and a role-approvals UI implemented; recovery/MFA and remaining controls remain
