...
- [ ] [18 — API Contracts & Security Boundary](./18-api-contracts-security-boundary.md) — every current application-owned operation has an enforced CI-validated OpenAPI 3.1 contract; future domain, file, webhook, and compatibility policy remain
