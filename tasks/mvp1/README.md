...
- [ ] [04 — Investor Onboarding & KYC](./04-investor-onboarding-kyc.md) — protected case lifecycle incl. reopen and eligibility projection, assigned-reviewer rejection, and own portal case actions implemented; classification, suitability, bank, completeness, approval, and eligibility restrictions remain
