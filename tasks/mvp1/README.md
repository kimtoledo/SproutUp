...
- [ ] [21 — Borrower & Investor Portal Journeys](./21-borrower-investor-portal-journeys.md) — public auth entry and permission-driven onboarding portal actions implemented; profile/detail/timeline screens and complete end-to-end journeys remain
