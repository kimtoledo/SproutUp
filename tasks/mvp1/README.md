...
- [ ] [01 — Platform Foundation](./01-platform-foundation.md) — monorepo, web/API health, shared contracts, database/CI, auth/audit, jobs, exact PHP money, balanced append-only ledger schema, and atomic posting primitive implemented; production infrastructure and remaining services remain
...
- [ ] [09 — Wallet Ledger & Bank Transfers](./09-wallet-ledger-bank-transfers.md) — exact PHP, balanced append-only generic ledger, and audited idempotent posting primitive implemented; full reversal, chart/holds, transfer workflow, approved calculations, and reconciliation remain
