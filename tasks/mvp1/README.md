...
- [ ] [02 — Authentication, RBAC & Audit](./02-auth-rbac-audit.md) — existing password/session boundary, access catalogue, own-session UI, staff RBAC, immutable audit, dual-controlled role changes, and role-approvals UI implemented; separate admin/borrower/investor account + auth relations and global email ownership now form the cutover foundation; runtime/data cutover, recovery/MFA, and remaining controls remain
