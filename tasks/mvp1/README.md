...
- [ ] [01 — Platform Foundation](./01-platform-foundation.md) — monorepo, web/API health, shared contracts, database/CI, auth/audit, jobs, exact PHP money, and balanced append-only ledger schema implemented; production infrastructure and remaining services remain
...
- [ ] [09 — Wallet Ledger & Bank Transfers](./09-wallet-ledger-bank-transfers.md) — exact PHP and balanced append-only generic ledger schema implemented; posting/reversal service, chart/holds, transfer workflow, approved calculations, and reconciliation remain
