...
- [ ] [02 — Authentication, RBAC & Audit](./02-auth-rbac-audit.md) — separate account relations, global email ownership, exact backfill, isolated admin runtime/cookie/context, admin-only RBAC/approval/reviewer foreign keys, legacy admin auth cleanup, controlled initial provisioning, immutable audit, and dual-controlled staff role changes are implemented; borrower/investor runtime and ownership cutover, recovery/MFA, and remaining controls remain
